...
public final class AOC2019 {
    ...
    private func getDay(_ number: Int) async throws -> Day {
        switch number {
		case 25: return try Day25(testInput: testInput)
		case 24: return try Day24(testInput: testInput)
		case 23: return try await Day23(testInput: testInput)
